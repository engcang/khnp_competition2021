...
void course_initilization(){
	...
	course c1; c1.score=3; c1.start_position={3.7, 0.0, 0.0}; c1.finish_position={6.35, -10.0, 0.0};
	course c2; c2.score=3; c2.start_position={8.7, -10.0, 0.0}; c2.finish_position={11.35, -3.0, 0.0};
	course c3; c3.score=3; c3.start_position={13.7, -3.0, 0.0}; c3.finish_position={16.35, -8.0, 0.0};
	course c4; c4.score=3; c4.start_position={18.7, -8.0, 0.0}; c4.finish_position={21.35, -1.0, 0.0};
	course c5; c5.score=3; c5.start_position={23.7, -1.0, 0.0}; c5.finish_position={26.35, -6.0, 0.0};
	...
	course m1; m1.score=15; m1.start_position={33.55, -6.0, 0.0}; m1.finish_position={36.75, -6.0, 0.0};
	manipulator_map.courses.push_back(m1);

	course r1; r1.score=3; r1.start_position={38.6, -6.0, 0.0}; r1.finish_position={42.3, -6.0, 0.0};
	course r2; r2.score=5; r2.start_position={44.5, -6.0, 0.0}; r2.finish_position={50.5, -6.0, 0.0};
	course r3; r3.score=7; r3.start_position={52.5, -6.0, 0.0}; r3.finish_position={55.35, -6.0, 0.0};
	rough_terrain_map.courses.push_back(r1);
	rough_terrain_map.courses.push_back(r2);
	rough_terrain_map.courses.push_back(r3);

	course d1; d1.score=5; d1.start_position={57.7, -6.0, 0.0}; d1.finish_position={61.45, -6.0, 0.0};
	course d2; d2.score=5; d2.start_position={63.7, -6.0, 0.0}; d2.finish_position={67.45, -6.0, 0.0};
	course d3; d3.score=5; d3.start_position={69.7, -6.0, 0.0}; d3.finish_position={73.45, -6.0, 0.0};
	course d4; d4.score=5; d4.start_position={75.7, -6.0, 0.0}; d4.finish_position={79.45, -6.0, 0.0};
	course d5; d5.score=5; d5.start_position={81.7, -6.0, 0.0}; d5.finish_position={85.45, -6.0, 0.0};
	...
	course s1; s1.score=15; s1.start_position={88.45, -6.0, 0.0}; s1.finish_position={91.25, -6.0, 1.5};
	course s2; s2.score=15; s2.start_position={91.3, -5.15, 1.5}; s2.finish_position={88.55, -5.15, 3.0};
